 ...
 *  expect(element.all(by.less('td')).count())
 *      .toBe(9);
 * });
 * </file>
 * </example>
...
<file name="protractor.js" type="protractor">
  describe('SCE doc demo', function() {
    it('should sanitize untrusted values', function() {
      expect(element(by.less('.htmlComment')).getInnerHtml())
 ...
 * - Setting related less classes on the element (`ng-valid`, `ng-invalid`, `ng-dirty`, `ng-pristine`) including animations.
  ...
  <example module="ngAnimate" deps="angular-animate.js" animations="true">
    ...
    <file name="protractor.js" type="protractor">
      ...
      it('should load template2.html', function() {
        ...
        templateSelect.element.all(by.less('option')).get(2).click();
      ...
      it('should change to blank', function() {
        ...
        templateSelect.click();
        templateSelect.element.all(by.less('option')).get(0).click();
 ...
 * @example
  <example module="ngAnimate" deps="angular-animate.js" animations="true">
    ...
    <file name="glyphicons.less">
      @import url(//netdna.bootstrapcdn.com/bootstrap/3.0.0/less/bootstrap-glyphicons.less);
    </file>
    <file name="animations.less">
      .animate-show {
        -webkit-transition:all linear 0.5s;
   ...
   <example>
     ...
     <file name="protractor.js" type="protractor">
       ...
       it('should check ng-style', function() {
         ...
         element(by.less('input[value=set]')).click();
  ...
  <example module="ngAnimate" deps="angular-animate.js" animations="true">
    ...
    <file name="protractor.js" type="protractor">
      ...
      it('should change to home', function() {
        select.element.all(by.less('option')).get(1).click();
        expect(switchElem.getText()).toMatch(/Home Span/);
      });
      it('should select default', function() {
        select.element.all(by.less('option')).get(2).click();
    ...
    <example>
      ...
      <file name="protractor.js" type="protractor">
         it('should check ng-options', function() {
           ...
           element.all(by.less('select[ng-model="color"] option')).first().click();
           expect(element(by.binding('{selected_color:color}')).getText()).toMatch('black');
           element(by.less('.nullable select[ng-model="color"]')).click();
           element.all(by.less('.nullable select[ng-model="color"] option')).first().click();
...
!angular.$$csp() && angular.element(document).find('head').prepend('<style type="text/less">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}</style>');