...
//                require('../lib/less/lessc_helper').printUsage();
            ...
            case 'depends':
                ...
                break;
            case 'yui-compress':
                warningMessages += "yui-compress option has been removed. assuming clean-less.";
...
//    options.sourceMapBasepath = process.cwd();
    ...
    if (options.sourceMap === true) {
        if (!output) {
            console.log("the sourcemap option only has an optional filename if the less filename is given");
            return;
        }
