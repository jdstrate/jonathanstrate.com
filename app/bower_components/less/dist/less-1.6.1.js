            ...
            root.toCSS = (function (evaluate) {
                return function (options, variables) {
                    ...
                    if (options.cleancss && less.mode === 'node') {
                        var CleanCSS = require('clean-less'),
...
tree.Import.prototype = {
    ...
    eval: function (env) {
        ...
        if (this.options.inline) {
            //todo needs to reference less file not import
...
tree.Selector.prototype = {
    ...
    match: function (other) {
        ...
        // ^ regexp could be more simple but see test/less/less-escapes.less:17, doh!
...
(function (tree) {
    ...
    var evalCopyProperties = [
        ...
        'cleancss',    // whether to compress with clean-less
...
function createCSS(styles, sheet, lastModified) {
    ...
    css.setAttribute('type', 'text/less');
    if (sheet.media) {
...
less.refresh = function (reload, modifyVars) {
    ...
    loadStyleSheets(function (e, root, _, sheet, env) {
        ...
        log("less for " + sheet.href + " generated in " + (new Date() - endTime) + 'ms', logLevel.info);
        if (env.remaining === 0) {
            log("less generated in " + (new Date() - startTime) + 'ms', logLevel.info);
        }
        endTime = new Date();
    }, reload, modifyVars);
