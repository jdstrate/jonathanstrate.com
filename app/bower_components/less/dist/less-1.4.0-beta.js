...
less.refresh = function (reload) {
    ...
    loadStyleSheets(function (e, root, _, sheet, env) {
        ...
        log("less for " + sheet.href + " generated in " + (new(Date) - endTime) + 'ms');
        (env.remaining === 0) && log("less generated in " + (new(Date) - startTime) + 'ms');
        endTime = new(Date);
    }, reload);
            ...
            try {
                ...
                new(less.Parser)(env).parse(data, function (e, root) {
                    ...
                    try {
                        ...
                        //TODO - there must be a better way? A generic less-to-less function that can both call error
